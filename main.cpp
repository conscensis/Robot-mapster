...
{
 float alpha,timeR,timeL;       //alpha - нужно повернуть колеса в градусах что бы пройти расстояние mewLength c радиусом колес Radius
 ...
 setEngneTimeL(timeL);                //присвоить время для вращения колеса L
